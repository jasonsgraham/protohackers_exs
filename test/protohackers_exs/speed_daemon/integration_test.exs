defmodule ProtohackersExs.SpeedDaemon.IntegrationTest do
  use ExUnit.Case, async: true

  alias ProtohackersExs.SpeedDaemon.Message
  ...
  test "pending tickets get flushed" do
    ...
    # We now have tickets on road 582, but no dispatcher for it.
